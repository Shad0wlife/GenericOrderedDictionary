        ...
        public T Current
        {
            get
            {
                if ((uint)_index >= (uint)_endIndex)
                    throw new InvalidOperationException("_index is >= _endIndex");
...
#pragma warning disable CA1822 // https://github.com/dotnet/roslyn-analyzers/issues/5911
        ...
        public object Current
        {
            get
            {
                throw new InvalidOperationException("Enumeration has not started.Call MoveNext. Won't work anyways.");
            }
        }
